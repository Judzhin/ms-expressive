...
folder are mapped to the application's root namespace, 'Expressive'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Expressive' in the same way
as `"Expressive/sass/src"`.
